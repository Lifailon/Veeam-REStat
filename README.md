...
Модуль, использующий **REST API (Invoke-WebRequest)** для сбора статистических данных. Можно использовать для быстрого анализа состава и состояния инфраструктуры Veeam Backup & Replication (VBR), настроки отправки Excel отчетов на почту о состоянии заданий и репозиториев (пример реализации **[Veeam-Job-Stat](https://github.com/Lifailon/Veeam-Job-Stat)**) и создание метрик для мониторинга (например, в Zabbix).
