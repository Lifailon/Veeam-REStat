...
Модуль, использующий **REST API через Invoke-WebRequest** для сбора статистических данных. Можно использовать для быстрого анализа состава и состояния инфраструктуры Veeam Backup & Replication (VBR), настроки оповещений на почту о состоянии заданий и репозиторием с выгрузкой в Excel (пример: **[Veeam-Job-Stat](https://github.com/Lifailon/Veeam-Job-Stat)**) и создание метрик для мониторинга (например, Zabbix).
